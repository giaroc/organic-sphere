...
const startApp = () => {
    ...
    const followMouseMovement = (event) => {
        ...
        const movementX = mouseX * 0.2;
        const movementY = mouseY * 0.2;

        // Applica il movimento alla sfera
        ico.position.x = movementX;
        ico.position.y = movementY;
        ico.rotation.x = movementY * 2;
